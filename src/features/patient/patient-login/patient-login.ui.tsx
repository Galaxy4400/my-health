import css from './patient-login.module.scss';
import { useState } from 'react';
import { yupResolver } from '@hookform/resolvers/yup';
import { Button, Form, Input } from 'shared/ui/form-components';
import { RequestData } from 'shared/api';
import { patientLoginFormRules } from './patient-login.rules';
...
export const PatientLogin = () => {
	...
	return (
		<div className={css['main']}>
			...
			<Form className={css['form']} onSubmit={submitHandler} resolver={yupResolver(patientLoginFormRules)}>
