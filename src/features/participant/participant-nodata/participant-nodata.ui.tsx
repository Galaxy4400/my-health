import css from './participant-nodata.module.scss';
import { useState } from 'react';
import { yupResolver } from '@hookform/resolvers/yup';
import { Button, Form, Input, Radio } from 'shared/ui/form-components';
import { RequestData } from 'shared/api';
import { participantNodataFormRules } from './participant-nodata.rules';
import { useNavigate } from 'react-router-dom';
import { path } from 'shared/lib/router';

export const ParticipantNodata = () => {
	...
	return (
		<div className={css['main']}>
			...
			<Form
				...
				resolver={yupResolver(participantNodataFormRules)}
			>
